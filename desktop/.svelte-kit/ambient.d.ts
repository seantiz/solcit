...
declare module '$env/static/public' {
	...
	export const PUBLIC_FILES_PATH: string;
	export const PUBLIC_SAVED_JOBDESC: string;
	export const PUBLIC_SAVED_CONFIG: string;
	export const PUBLIC_SAVED_CV_DETAILS: string;
}
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_SAVED_JOBDESC: string;
		PUBLIC_SAVED_CONFIG: string;
		PUBLIC_SAVED_CV_DETAILS: string;
